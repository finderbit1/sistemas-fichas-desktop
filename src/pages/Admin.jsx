...
const AdminPage = () => {
  ...
  return (
    <Container className="mt-4">
      <h3 className="mb-4">
        <MdAdminPanelSettings size={28} style={{ marginRight: '8px', verticalAlign: 'middle' }} />
      ...
      <Row>
        ...
        <Col md={12} className="mt-4">
          <Card className="p-4 text-center bg-info-subtle">
            <h5>Gerar Relatório de Fechamento</h5>
            <p className="mb-2">Relatório geral com base nos pedidos realizados</p>
            <Button variant="outline-dark" onClick={() => alert('Relatório gerado com sucesso!')}>
              Gerar Relatório
            </Button>
          </Card>
        </Col>
